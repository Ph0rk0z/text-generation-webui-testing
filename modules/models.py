...
def load_model(model_name, loader=None):
    ...
    if any((shared.args.xformers, shared.args.sdp_attention, shared.args.flash_attention)) and shared.args.loader not in ['ExLlamav2', 'ExLlamav2_HF', 'llama.cpp', 'llamacpp_HF']:
