            ...
            with gr.Box():
                with gr.Row():
                    with gr.Column():
                        ...
                        shared.gradio['alpha_emb'] = gr.Slider(label='alpha_emb', minimum=1, maximum=8, step=1, info='RoPE Scaling. Should typically be set to max_seq_len / 2048.', value=shared.args.alpha_emb)
